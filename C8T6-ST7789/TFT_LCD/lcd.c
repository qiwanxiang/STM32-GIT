...
#define LCD_TOTAL_BUF_SIZE (240 * 240 * 2) // clear()
#define LCD_Buf_Size 1152                  // clear()&fill()
...
/**
 * @brief	LCD底层SPI发送数据函数,需在main.c重写
 *
 * @param   data	数据的起始地址
 * @param   size	发送数据大小
 *
 ...
 *						   1--文字悬浮
 * 输出  ：无
 * 举例  ：PutChinese_strings(200,100,"好人",0);
 * 注意	 ：无
 *********************************************************/
