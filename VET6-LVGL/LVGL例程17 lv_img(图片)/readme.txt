 ...
 ***************************************************************************************************
 * 实验简介
 * 实验名称：LVGL lv_img(图片) 实验
 * 实验平台：正点原子 探索者 F407开发板
 * 实验目的：学习LVGL lv_img(图片)部件的使用
 ...
 ***************************************************************************************************
 * 实验现象
 * 1 开机后，在屏幕上显示1张图片和6个控制滑块，用户调整不同滑块的值，即可使图片发生相应变化。
 * 2 自上而下的方向，滑块1~2分别控制图片的缩放、旋转角度；滑块3~6分别控制图片重新着色的R、G、B通道值以及透明度。
 * 3 LED0闪烁 ,提示程序运行。
